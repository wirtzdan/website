...
function PrivacyPage() {
  return (
    <Layout>
      <SEO keywords={[]} title="Privacy Policy" />
      <Section>
        ...
        <p>
          ...
          of the Daniel Wirtz. The use of the Internet pages of the Daniel Wirtz
        ...
        <p>
          ...
          the Daniel Wirtz. By means of this data protection declaration, our
        ...
        <p>
          As the controller, the Daniel Wirtz has implemented numerous technical
        ...
        <h4>1. Definitions</h4>
        <p>
          The data protection declaration of the Daniel Wirtz is based on the
        ...
        <p>52070 Aachen</p>
        <p>Germany</p>
        <p>Phone: +4915255181401</p>
        <p>Email: hello@danielwirtz.com</p>
        <p>Website: https://danielwirtz.com</p>

        <h4>3. Cookies</h4>
        <p>
          The Internet pages of the Daniel Wirtz use cookies. Cookies are text
        ...
        <p>
          Through the use of cookies, the Daniel Wirtz can provide the users of
        ...
        <p>
          The website of the Daniel Wirtz collects a series of general data and
        ...
        <p>
          When using these general data and information, the Daniel Wirtz does
          ...
          prosecution in case of a cyber-attack. Therefore, the Daniel Wirtz
        ...
        <p>
          On the website of the Daniel Wirtz, users are given the opportunity to
        ...
        <p>
          The Daniel Wirtz informs its customers and business partners regularly
        ...
        <p>
          The newsletter of the Daniel Wirtz contains so-called tracking pixels.
          A tracking pixel is a miniature graphic embedded in such e-mails,
          ...
          the Daniel Wirtz may see if and when an e-mail was opened by a data
        ...
        <p>
          ...
          the controller. The Daniel Wirtz automatically regards a withdrawal
          from the receipt of the newsletter as a revocation.
        </p>

        <h4>7. Contact possibility via the website </h4>
        <p>
          The website of the Daniel Wirtz contains information that enables a
        ...
        <p>
          The Daniel Wirtz offers users the possibility to leave individual
        ...
        <p>
          The comments made in the blog of the Daniel Wirtz may be subscribed to
        ...
        <ul className="list-none">
          ...
          <li>
            ...
            <p>
              ...
              Daniel Wirtz, he or she may, at any time, contact any employee of
              the controller. An employee of Daniel Wirtz shall promptly ensure
            ...
            <p>
              ...
              far as processing is not required. An employees of the Daniel
              Wirtz will arrange the necessary measures in individual cases.
            </p>
          </li>
          <li>
            ...
            <p>
              ...
              data stored by the Daniel Wirtz, he or she may at any time contact
              any employee of the controller. The employee of the Daniel Wirtz
          ...
          <li>
            ...
            <p>
              ...
              may at any time contact any employee of the Daniel Wirtz.
            </p>
          </li>
          <li>
            ...
            <p>
              The Daniel Wirtz shall no longer process the personal data in the
            ...
            <p>
              If the Daniel Wirtz processes personal data for direct marketing
              ...
              the Daniel Wirtz to the processing for direct marketing purposes,
              the Daniel Wirtz will no longer process the personal data for
              these purposes.
            </p>
            ...
            <p>
              ...
              personal data concerning him or her by the Daniel Wirtz for
            ...
            <p>
              ...
              contact any employee of the Daniel Wirtz. In addition, the data
          ...
          <li>
            ...
            <p>
              ...
              consent, the Daniel Wirtz shall implement suitable measures to
            ...
            <p>
              ...
              contact any employee of the Daniel Wirtz.
            </p>
          </li>
          <li>
        ...
        <h4>
          17. The legitimate interests pursued by the controller or by a third
          party
        </h4>
        <p>
        ...
        <h4>
          19. Provision of personal data as statutory or contractual
        ...
        <p>
          ...
          <a href="https://www.wbs-law.de/eng/practice-areas/media-law/">
            Media Law Lawyers
          </a>{" "}
          from WBS-LAW.
        </p>
