      ...
      <VStack spacing={16}>
        ...
        <Section>
          <VStack align="start" spacing={8}>
            ...
            <VStack spacing={4}>
              <Text>
                If you want to stay up to date with my latest posts you can sign up to my
                newsletter. I promise I won&apos;t spam you. (To be honest, I&apos;m not the best at
                keeping up with a newsletter schedule...)
              </Text>
