...
[Roam42](https://roamresearch.com/#/app/roamhacker/page/-1s5kPhyX) is the Swiss Army knife for Roam Research and adds a range of powerful features to your graph. Among them is a feature called Smartblocks, which we will use for our journal prompts.
...
```md title="Random Journal Prompt Template"
